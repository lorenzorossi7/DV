//=============================================================================
//
// pieces of this code copied verbatim from one of the NCAR examples: 
//
// /usr/local/lib/ncarg/examples/c_tdex01.c
//
// TEMPORARILY DISABLED ... to re-enable, add object to Makefile.in, and
// and add libs/header to configure.in
//
//=============================================================================
...
//=============================================================================
//
// a few WKTP types ... see the web page docs for more
//
// 1 -- CGM (meta file)
// 8 -- New X11 window
