/** Header file generated with fdesign on Mon Jul  9 02:44:25 2001.**/
...
extern void help_menu_cb(FL_OBJECT *, long);
...
extern void send_to_acceptXYZ_cb(FL_OBJECT *, long);
...
extern void gl_render_mode_cb(FL_OBJECT *, long);
extern void gl_home_cb(FL_OBJECT *, long);
extern void gl_draw_bboxes_cb(FL_OBJECT *, long);
extern void gl_screen_capture_cb(FL_OBJECT *, long);
extern void gl_annotation_cb(FL_OBJECT *, long);
extern void gl_freeze_lens_cb(FL_OBJECT *, long);
...
typedef struct {
	...
	FL_OBJECT *send_to_acceptXYZ_menu;
	FL_OBJECT *diff;
	FL_OBJECT *functions;
} FD_DV_main_window;
...
typedef struct {
	...
	long  ldata;
	FL_OBJECT *gl_canvas;
	FL_OBJECT *render_mode;
	FL_OBJECT *home;
	FL_OBJECT *gl_canvas_text;
	FL_OBJECT *draw_bboxes;
	FL_OBJECT *screen_capture;
	FL_OBJECT *annotation;
