...
{ 
    ...
    { "All",	0,	"",	 FL_PUP_NONE},
    { "Last time of Selected",	0,	"",	 FL_PUP_NONE},
    {0}
};
...
FD_DV_main_window *create_form_DV_main_window(void)
{
  ...
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,430,230,180,220,"Visualization");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,460,300,140,100,"");
  ...
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,20,70,400,380,"Data-Vault contents");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_SouthEast);
  fdui->dv_browser = obj = fl_add_browser(FL_MULTI_BROWSER,30,90,380,350,"");
  ...
  obj = fl_add_button(FL_NORMAL_BUTTON,500,360,80,30,"options");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,options_cb,0);
  obj = fl_add_button(FL_NORMAL_BUTTON,450,410,140,30,"Data Browser");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,data_browser_cb,0);
  fdui->send_to_explorer_menu = obj = fl_add_button(FL_NORMAL_BUTTON,450,290,140,30,"Send to Explorer");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,send_to_explorer_cb,0);
  fdui->send_to_acceptSDF_menu = obj = fl_add_button(FL_NORMAL_BUTTON,450,250,140,30,"Send to AcceptSDF");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,send_to_acceptSDF_cb,0);
  fdui->send_to_local = obj = fl_add_button(FL_NORMAL_BUTTON,450,320,140,30,"Send to local view");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_BOLD_STYLE);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
...
static FL_PUP_ENTRY fdchoice_diff_stencil_5[] =
{ 
    /*  itemtext   callback  shortcut   mode */
...
FD_DV_diff_window *create_form_DV_diff_window(void)
{
  ...
  fdui->DV_diff_window = fl_bgn_form(FL_NO_BOX, 820, 230);
  obj = fl_add_box(FL_UP_BOX,0,0,820,230,"");
  ...
  fdui->diff_wrt = obj = fl_add_choice(FL_NORMAL_CHOICE2,250,70,100,30,"with respect to");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->diff_overwrite = obj = fl_add_checkbutton(FL_PUSH_BUTTON,630,120,120,30,"over-write existing \n registers?");
    ...
    fl_set_object_callback(obj,null_cb,0);
    fl_set_button(obj, 1);
  fdui->diff_stencil = obj = fl_add_choice(FL_NORMAL_CHOICE2,250,130,100,30,"spatial stencil");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_TOP);
    fl_set_object_gravity(obj, FL_NorthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
    fl_set_choice_entries(obj, fdchoice_diff_stencil_5);
  fl_end_form();
...
FD_DV_func_window *create_form_DV_func_window(void)
{
  ...
  fdui->func_args = obj = fl_add_input(FL_NORMAL_INPUT,400,360,240,30,"Arguments");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_SouthEast, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->func_mask_val = obj = fl_add_input(FL_NORMAL_INPUT,500,320,140,30,"Mask value");
    ...
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->givec = obj = fl_add_input(FL_NORMAL_INPUT,70,360,240,30,"Filter ");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_SouthWest, FL_SouthEast);
    fl_set_object_resize(obj, FL_RESIZE_Y);
...
static FL_PUP_ENTRY fdmenu_gl_options_menu_6[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "Point",	0,	"",	 FL_PUP_NONE},
    ...
    { "--------------------------",	0,	"",	 FL_PUP_NONE},
    { "Draw bounding-boxes",	0,	"",	 FL_PUP_RADIO},
    { "--------------------------",	0,	"",	 FL_PUP_NONE},
    { "Screen Capture",	0,	"",	 FL_PUP_NONE},
    { "Annotation",	0,	"",	 FL_PUP_NONE},
    { "--------------------------",	0,	"",	 FL_PUP_NONE},
    { "Set Zoom A",	0,	"",	 FL_PUP_NONE},
    { "Set Zoom B",	0,	"",	 FL_PUP_NONE},
    {0}
};

static FL_PUP_ENTRY fdchoice_gl_zoom_hist_7[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "zoom",	0,	"",	 FL_PUP_NONE},
    {0}
...
static FL_PUP_ENTRY fdchoice_gl_theta_hist_8[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "theta",	0,	"",	 FL_PUP_NONE},
    {0}
...
static FL_PUP_ENTRY fdchoice_gl_phi_hist_9[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "phi",	0,	"",	 FL_PUP_NONE},
    {0}
...
FD_DV_gl_canvas_window *create_form_DV_gl_canvas_window(void)
{
  ...
  fdui->DV_gl_canvas_window = fl_bgn_form(FL_NO_BOX, 780, 730);
  obj = fl_add_box(FL_UP_BOX,0,0,780,730,"");
  obj = fl_add_frame(FL_ENGRAVED_FRAME,10,10,760,710,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_SouthEast);
  ...
  obj = fl_add_frame(FL_ENGRAVED_FRAME,110,10,480,50,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  fdui->gl_canvas = obj = fl_add_glcanvas(FL_NORMAL_CANVAS,20,110,740,600,"");
    fl_set_object_color(obj,FL_BLACK,FL_YELLOW);
    fl_set_object_gravity(obj, FL_NorthWest, FL_SouthEast);
  fdui->gl_canvas_text = obj = fl_add_text(FL_NORMAL_TEXT,20,70,740,30,"text");
    fl_set_object_boxtype(obj,FL_UP_BOX);
  ...
  fdui->gl_options_menu = obj = fl_add_menu(FL_PULLDOWN_MENU,20,20,80,30,"Options");
    ...
    fl_set_menu_entries(obj, fdmenu_gl_options_menu_6);
  fdui->gl_zoom_hist = obj = fl_add_choice(FL_NORMAL_CHOICE2,190,20,60,30,"");
    ...
    fl_set_choice_entries(obj, fdchoice_gl_zoom_hist_7);
  fdui->gl_theta_hist = obj = fl_add_choice(FL_NORMAL_CHOICE2,310,20,60,30,"");
    ...
    fl_set_choice_entries(obj, fdchoice_gl_theta_hist_8);
  fdui->gl_phi_hist = obj = fl_add_choice(FL_NORMAL_CHOICE2,430,20,60,30,"");
    ...
    fl_set_choice_entries(obj, fdchoice_gl_phi_hist_9);
  obj = fl_add_frame(FL_ENGRAVED_FRAME,590,10,180,50,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NorthEast);
    fl_set_object_resize(obj, FL_RESIZE_X);
...
FD_DV_sl_opts_window *create_form_DV_sl_opts_window(void)
{
  ...
  fdui->DV_sl_opts_window = fl_bgn_form(FL_NO_BOX, 530, 300);
  obj = fl_add_box(FL_UP_BOX,0,0,530,300,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
  obj = fl_add_labelframe(FL_ENGRAVED_FRAME,10,20,510,270,"Send to local view options");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  obj = fl_add_frame(FL_ENGRAVED_FRAME,250,240,270,50,"");
  obj = fl_add_frame(FL_ENGRAVED_FRAME,10,240,240,50,"");
  fdui->scale = obj = fl_add_input(FL_NORMAL_INPUT,60,40,100,30,"scale");
    ...
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->cmap_range_minz = obj = fl_add_input(FL_NORMAL_INPUT,130,80,90,30,"colormap range");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->cmap_range_maxz = obj = fl_add_input(FL_NORMAL_INPUT,220,80,90,30,"");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->amr = obj = fl_add_checkbutton(FL_PUSH_BUTTON,440,200,30,30,"AMR");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->cmap_hist = obj = fl_add_choice(FL_NORMAL_CHOICE2,310,80,80,30,"");
    fl_set_object_lsize(obj,FL_NORMAL_SIZE);
    fl_set_object_lstyle(obj,FL_TIMESBOLDITALIC_STYLE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->cmap_type = obj = fl_add_choice(FL_NORMAL_CHOICE2,440,80,70,30,"type");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  ...
  fdui->zmax_clip = obj = fl_add_input(FL_NORMAL_INPUT,440,40,70,30,"max");
    ...
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->sync = obj = fl_add_choice(FL_NORMAL_CHOICE2,140,200,130,30,"");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,sl_opts_sync_cb,0);
    fl_set_choice_entries(obj, fdchoice_sync_14);
  fdui->concat = obj = fl_add_choice(FL_NORMAL_CHOICE2,280,200,150,30,"");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
  ...
  fdui->sl_opts_ingore_ccoords = obj = fl_add_checkbutton(FL_PUSH_BUTTON,10,250,30,30,"Ignore curvilinear coordinates");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,sl_opts_ignore_cb,0);
  obj = fl_add_checkbutton(FL_PUSH_BUTTON,300,250,30,30,"zoom");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_lalign(obj,FL_ALIGN_LEFT);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,sl_opts_zoom_cb,0);
  fdui->zoom_a = obj = fl_add_input(FL_NORMAL_INPUT,350,250,70,30,"A");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,null_cb,0);
  fdui->zoom_b = obj = fl_add_input(FL_NORMAL_INPUT,440,250,70,30,"B");
    fl_set_object_color(obj,FL_DARKER_COL1,FL_LIGHTER_COL1);
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
...
static FL_PUP_ENTRY fdchoice_pointsize_19[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "1",	0,	"",	 FL_PUP_NONE},
    { "2",	0,	"",	 FL_PUP_NONE},
...
static FL_PUP_ENTRY fdchoice_linewidth_20[] =
{ 
    /*  itemtext   callback  shortcut   mode */
    { "1",	0,	"",	 FL_PUP_NONE},
    { "2",	0,	"",	 FL_PUP_NONE},
...
FD_DV_annotation_window *create_form_DV_annotation_window(void)
{
  ...
  obj = fl_add_frame(FL_ENGRAVED_FRAME,10,260,200,50,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NorthEast);
  ...
  obj = fl_add_choice(FL_NORMAL_CHOICE2,90,270,40,30,"bounding\nbox width");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    ...
    fl_set_choice(obj,1);
  obj = fl_add_button(FL_NORMAL_BUTTON,130,270,60,30,"color");
  ...
  obj = fl_add_frame(FL_ENGRAVED_FRAME,10,210,480,50,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NorthEast);
  obj = fl_add_frame(FL_ENGRAVED_FRAME,210,260,280,50,"");
    fl_set_object_gravity(obj, FL_NorthWest, FL_NorthEast);
  obj = fl_add_choice(FL_NORMAL_CHOICE2,290,270,40,30,"point size");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,gl_ann_1d_pt_size_cb,0);
    fl_set_choice_entries(obj, fdchoice_pointsize_19);
    fl_set_choice(obj,4);
  obj = fl_add_choice(FL_NORMAL_CHOICE2,430,270,40,30,"line width");
    fl_set_object_lsize(obj,FL_MEDIUM_SIZE);
    fl_set_object_gravity(obj, FL_NorthWest, FL_NoGravity);
    fl_set_object_resize(obj, FL_RESIZE_NONE);
    fl_set_object_callback(obj,gl_ann_1d_line_width_cb,0);
    fl_set_choice_entries(obj, fdchoice_linewidth_20);
    fl_set_choice(obj,2);
  fl_end_form();
