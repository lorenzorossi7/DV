...
dnl                    AC_MSG_RESULT($CCF77LIBS)
                 ...
                 *)
                    ...
                    *) ;;
                    ...
                    CFLAGS_NOOPT="$CFLAGS_NOOPT -fcommon"
                    CPPFLAGS="$CPPFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
                    CXXFLAGS="$CXXFLAGS -DLINUX -DPORT_GROUP -DWant_c_files"
dnl----------------------------------------------------------------------
...
dnl changequote(,)dnl
   if gfortran --version 2>&1 | grep ' 4.1' > /dev/null 2>&1; then
      ...
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 5.5' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 7.[[0-9]]' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 8.[[0-9]]' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 9.[[0-9]]' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
   elif gfortran --version 2>&1 | grep ' 10.[[0-9]]' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
      F77FLAGS="$F77FLAGS -w -fallow-argument-mismatch";
      F77LFLAGS="$F77LFLAGS -w -fallow-argument-mismatch";
   elif gfortran --version 2>&1 | grep ' 11.[[0-9]]' > /dev/null 2>&1; then
      CPPFLAGS="$CPPFLAGS -DGFORTRAN43_OR_LATER";
      F77FLAGS="$F77FLAGS -w -fallow-argument-mismatch";
      F77LFLAGS="$F77LFLAGS -w -fallow-argument-mismatch";
   else
